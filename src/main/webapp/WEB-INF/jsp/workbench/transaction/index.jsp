...
<body>
	...
	<%--<div style="position: relative; top: -20px; left: 0px; width: 100%; height: 100%;">
		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div class="btn-toolbar" role="toolbar" style="position: relative; top: -20px; left: 0px; width: 100%; height: 100%;">
			...
			<div style="position: relative;top: 10px;">
				<table class="table table-hover">
					...
					<tbody>
						<tr>
							<td><input type="checkbox" /></td>
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/transaction/toTranDetail.do?id=71991bff3ec142ca87ee04aa48987df8';">神马重工-交易01</a></td>
							<td>神马重工</td>
							<td>谈判/复审</td>
							<td>新业务</td>
							<td>zhangsan</td>
