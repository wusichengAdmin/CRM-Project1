...
<head>
	...
	<script type="text/javascript">
		...
		$(function(){
             ...
             */
			window.open("workbench/activity/toActivityIndex.do","workareaFrame");
...
<div id="top" style="height: 50px; background-color: #3C3C3C; width: 100%;">
	<div style="position: absolute; top: 5px; left: 0px; font-size: 30px; font-weight: 400; color: white; font-family: 'times new roman'">CRM &nbsp;<span style="font-size: 12px;">物电学院&nbsp;吴思呈</span></div>
		...
		<ul id="no1" class="nav nav-pills nav-stacked">
			...
			<li class="liClass">
				...
				<ul id="no2" class="nav nav-pills nav-stacked collapse">
					...
					<li class="liClass"><a href="workbench/chart/transaction/toCharTranIndex.do" target="workareaFrame">&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-chevron-right"></span> 交易统计图表</a></li>
				</ul>
			</li>
		</ul>
