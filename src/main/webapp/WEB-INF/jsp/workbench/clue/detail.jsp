...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#searchName").keydown(function (event) {
			...
			if(event.keyCode == 13){
				...
				$.ajax({
					...
					url : "workbench/clue/getActivityNameAndNotByClueId.do",
					data:{
		...
		$("#bindBtn").click(function () {
		    ...
		    /*
		      由于我们是要做关联操作，那么其实就是线索和市场活动的关联关系表的添加操作
		      需要的参数:
		          clueId(当前线索的详细信息)
		          activityId：是我们根据结果，在复选框中进行挑勾，选中实现的
		          可以在复选框中同时挑多个勾已实现批量关联操作
