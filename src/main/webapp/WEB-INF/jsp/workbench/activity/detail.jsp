...
<script type="text/javascript">
				...
				success : function (data) {
                    ...
                    */
					if( im == "" ){
						...
						//为新增记录创建一个div,然后将div追加到添加文本域的上方
						var html="";
		...
		$.ajax({
			...
			success:function (data) {
				...
				$.each(data,function (i,n) {
					...
					html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
					html += '<a class="myHref" href="javascript:void(0);" onclick="toActivityRemarkUpdate(\''+n.id+'\')"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #FF0000;"></span></a>';
					html += '&nbsp;&nbsp;&nbsp;&nbsp;';
	...
	function toActivityRemarkUpdate(id) {

		//找到对应的h5标签，从该h5标签中取得里面的信息，就是我们要修改的备注信息
		var noteContent = $("#e"+id).html();

		//将需要修改的信息填充到修改操作模态窗口的文本域中
	    ...
	    $.ajax({
            ...
            success:function (data) {
                ...
                if(data.success){
                    ...
                    //不能直接刷新列表，会造成前端数据越刷越多的情况

                    //找到删除记录所在的div，然后将div移除
                    $("#"+id).remove();
