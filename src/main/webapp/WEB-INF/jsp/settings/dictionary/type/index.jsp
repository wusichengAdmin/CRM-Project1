...
<script type="text/javascript" src="jquery/bootstrap_3.3.0/js/bootstrap.min.js"></script>
	<script>
		...
		$(function () {
			...
			//为编辑按钮绑定事件，再跳转到类型修改页
			$("#toTypeUpdateBtn").click(function () {
            ...
            $("#qx").click(function () {
                ...
                //方法二：
                $("input[name=xz]").prop("checked",this.checked);  //this：在这里面在哪个方法上绑定事件this就代表谁的dom对象，可以把上面的语句变为：
...
<body>
	...
	<div class="btn-toolbar" role="toolbar" style="background-color: #F7F7F7; height: 50px; position: relative;left: 30px;">
		<div class="btn-group" style="position: relative; top: 18%;">
		  ...
		  <button type="button" class="btn btn-default" id="toTypeUpdateBtn"><span class="glyphicon glyphicon-edit"></span> 编辑</button>
