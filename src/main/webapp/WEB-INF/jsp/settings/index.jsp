			...
			<ul>
				<li class="dropdown user-dropdown">
					<a href="javascript:void(0)" style="text-decoration: none; color: white;" class="dropdown-toggle" data-toggle="dropdown">
						<span class="glyphicon glyphicon-user"></span> ${user.name}&nbsp <span class="caret"></span>
					</a>
					<ul class="dropdown-menu">
						<li><a href="workbench/toWorkbenchIndex.do"><span class="glyphicon glyphicon-home"></span> 工作台</a></li>
